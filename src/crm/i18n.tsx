...
export const CRM_T: Record<Lang, any> = {
  ...
  ru: {
    ...
    staff: { title: 'Сотрудники', add: 'Добавить сотрудника', role: 'Должность', bookings: 'Записи', revenue: 'Выручка', rating: 'Рейтинг', load: 'Загрузка', today: 'Сегодня', schedule: 'График', edit: 'Изменить', slots: 'Слоты', delete: 'Удалить', phone: 'Телефон', photoRemove: 'Удалить фото', noRole: 'Специалист', clients: 'Клиенты', noClients: 'Пока нет клиентов', clientsSub: 'Клиенты, которые записывались к этому мастеру', quick: 'Быстрая настройка', from: 'С', to: 'До', apply: 'Отметить', selectAll: 'Все', clearDay: 'Очистить', copyTo: 'Скопировать на другие дни', copyAll: 'На все дни', copied: 'Скопировано', slotCount: 'слот.', dayOffLabel: 'Выходной' },
