...
export const CRM_T: Record<Lang, any> = {
  uz: {
    ...
    install: { title: 'Ilovani o‘rnating', body: 'Tezroq ochiladi va telefoningizning bosh ekranidan ishlaydi.', action: 'O‘rnatish', iosBody: 'Pastdagi «Ulashish» tugmasini bosing, so‘ng «Bosh ekranga qo‘shish»ni tanlang.', macBody: 'Safari’da: File → Add to Dock.', installedTitle: 'Ilova o‘rnatilgan', installedBody: 'Uni bosh ekraningizdan oching — brauzerdan tezroq ishlaydi.', dismiss: 'Yopish' },
  ...
  ru: {
    ...
    install: { title: 'Установите приложение', body: 'Открывается быстрее и работает с главного экрана.', action: 'Установить', iosBody: 'Нажмите «Поделиться» внизу, затем «На экран «Домой»».', macBody: 'В Safari: File → Add to Dock.', installedTitle: 'Приложение установлено', installedBody: 'Откройте его с главного экрана — так быстрее, чем через браузер.', dismiss: 'Скрыть' },
  ...
  en: {
    ...
    install: { title: 'Install the app', body: 'It opens faster and runs from your home screen.', action: 'Install', iosBody: 'Tap Share below, then Add to Home Screen.', macBody: 'In Safari: File → Add to Dock.', installedTitle: 'You have the app', installedBody: 'Open it from your home screen — it is quicker than the browser.', dismiss: 'Dismiss' },
