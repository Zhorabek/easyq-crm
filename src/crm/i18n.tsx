...
export const CRM_T: Record<Lang, any> = {
  uz: {
    ...
    install: { title: 'Ilovani o‘rnating', body: 'Tezroq ochiladi va telefoningizning bosh ekranidan ishlaydi.', bodyDesktop: 'Alohida oynada ochiladi — brauzer yorliqlarisiz, ish stolidan bir bosishda.', later: 'Keyinroq', action: 'O‘rnatish', iosBody: 'Pastdagi «Ulashish» tugmasini bosing, so‘ng «Bosh ekranga qo‘shish»ni tanlang.', macBody: 'Safari’da: File → Add to Dock.', installedTitle: 'Ilova o‘rnatilgan', installedBody: 'Uni bosh ekraningizdan oching — brauzerdan tezroq ishlaydi.', installedBodyDesktop: 'Uni ish stolingizdan oching — brauzerdan tezroq ishlaydi.', open: 'Ilovada ochish', openFailed: 'Ilova ochilmadi. Uni bosh ekran yoki ish stolidan oching.', dismiss: 'Yopish' },
  ...
  ru: {
    ...
    install: { title: 'Установите приложение', body: 'Открывается быстрее и работает с главного экрана телефона.', bodyDesktop: 'Открывается в отдельном окне — без вкладок браузера, в один клик с рабочего стола.', later: 'Позже', action: 'Установить', iosBody: 'Нажмите «Поделиться» внизу, затем «На экран «Домой»».', macBody: 'В Safari: File → Add to Dock.', installedTitle: 'Приложение установлено', installedBody: 'Откройте его с главного экрана — так быстрее, чем через браузер.', installedBodyDesktop: 'Откройте его с рабочего стола — так быстрее, чем через браузер.', open: 'Открыть в приложении', openFailed: 'Не удалось открыть. Запустите приложение с главного экрана или рабочего стола.', dismiss: 'Скрыть' },
  ...
  en: {
    ...
    install: { title: 'Install the app', body: 'It opens faster and runs from your phone’s home screen.', bodyDesktop: 'It opens in its own window — no browser tabs, one click from your desktop.', later: 'Later', action: 'Install', iosBody: 'Tap Share below, then Add to Home Screen.', macBody: 'In Safari: File → Add to Dock.', installedTitle: 'You have the app', installedBody: 'Open it from your home screen — it is quicker than the browser.', installedBodyDesktop: 'Open it from your desktop — it is quicker than the browser.', open: 'Open in the app', openFailed: 'That did not open it. Launch the app from your home screen or desktop.', dismiss: 'Dismiss' },
