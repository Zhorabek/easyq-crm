...
export const CRM_T: Record<Lang, any> = {
  uz: {
    ...
    fin: { currency: 'so‘m', addPayment: 'To‘lov qo‘shish', sub: 'Kassa va to‘lovlar', today: 'Bugungi tushum', cash: 'Naqd', card: 'Karta', online: 'Onlayn', transfer: 'O‘tkazma', other: 'Boshqa', txns: 'So‘nggi to‘lovlar', byMethod: 'To‘lov usuli bo‘yicha', count: 'ta to‘lov', avgCheck: 'O‘rtacha chek', incoming: 'Kirim', refund: 'Qaytarish', noTxns: 'Bu kunda to‘lovlar yo‘q' },
  ...
  en: {
    ...
    fin: { currency: 'so‘m', addPayment: 'Add payment', sub: 'Cash desk & payments', today: 'Today’s revenue', cash: 'Cash', card: 'Card', online: 'Online', transfer: 'Transfer', other: 'Other', txns: 'Recent payments', byMethod: 'By payment method', count: 'payments', avgCheck: 'Avg. check', incoming: 'Incoming', refund: 'Refund', noTxns: 'No payments on this day' },
