...
export const CRM_T: Record<Lang, any> = {
  uz: {
    ...
    staff: { title: 'Xodimlar', add: 'Xodim qo‘shish', role: 'Lavozim', bookings: 'Navbatlar', revenue: 'Tushum', rating: 'Reyting', load: 'Yuklama', today: 'Bugun', schedule: 'Jadval', edit: 'Tahrirlash', slots: 'Slotlar', delete: 'O‘chirish', phone: 'Telefon', noRole: 'Mutaxassis', clients: 'Mijozlar', noClients: 'Hali mijoz yo‘q', clientsSub: 'Bu ustaga yozilgan mijozlar', quick: 'Tez sozlash', from: 'Dan', to: 'Gacha', apply: 'Belgilash', selectAll: 'Hammasi', clearDay: 'Tozalash', copyTo: 'Boshqa kunlarga ko‘chirish', copyAll: 'Barcha kunlarga', copied: 'Ko‘chirildi', slotCount: 'slot', dayOffLabel: 'Dam olish kuni' },
    ...
    set: {
      ...
      brand: 'Brend', logoErr_empty: 'Bu fayl bo‘sh.', logoErr_too_large: 'Rasm 4 MB dan katta. Kichikroq fayl yuklang.', logoErr_svg_or_html: 'SVG va HTML fayllar qabul qilinmaydi. PNG, JPG yoki WebP yuklang.', logoErr_executable: 'Bu rasm emas, dastur. PNG, JPG yoki WebP yuklang.', logoErr_archive: 'Bu rasm emas, arxiv. PNG, JPG yoki WebP yuklang.', logoErr_pdf: 'Bu rasm emas, PDF. PNG, JPG yoki WebP yuklang.', logoErr_not_an_image: 'Bu fayl PNG, JPG yoki WebP rasm emas.', logo: 'Logotip', logoSub: 'Navbat sahifasi va CRM’da ko‘rinadi', logoHint: 'PNG yoki JPG, kvadrat rasm eng yaxshi ko‘rinadi. Yuklamasangiz biznes nomining birinchi harfi ishlatiladi.', logoUpload: 'Logotip yuklash', logoReplace: 'Almashtirish', logoRemove: 'O‘chirish', brandSub: 'Navbat sahifangiz shu ranglarda ko‘rinadi', brandCustom: 'O‘z ranglaringiz',
  ...
  ru: {
    ...
    staff: { title: 'Сотрудники', add: 'Добавить сотрудника', role: 'Должность', bookings: 'Записи', revenue: 'Выручка', rating: 'Рейтинг', load: 'Загрузка', today: 'Сегодня', schedule: 'График', edit: 'Изменить', slots: 'Слоты', delete: 'Удалить', phone: 'Телефон', noRole: 'Специалист', clients: 'Клиенты', noClients: 'Пока нет клиентов', clientsSub: 'Клиенты, которые записывались к этому мастеру', quick: 'Быстрая настройка', from: 'С', to: 'До', apply: 'Отметить', selectAll: 'Все', clearDay: 'Очистить', copyTo: 'Скопировать на другие дни', copyAll: 'На все дни', copied: 'Скопировано', slotCount: 'слот.', dayOffLabel: 'Выходной' },
    ...
    set: {
      ...
      brand: 'Бренд', logoErr_empty: 'Файл пустой.', logoErr_too_large: 'Изображение больше 4 МБ. Загрузите файл меньше.', logoErr_svg_or_html: 'SVG и HTML не принимаются. Загрузите PNG, JPG или WebP.', logoErr_executable: 'Это программа, а не изображение. Загрузите PNG, JPG или WebP.', logoErr_archive: 'Это архив, а не изображение. Загрузите PNG, JPG или WebP.', logoErr_pdf: 'Это PDF, а не изображение. Загрузите PNG, JPG или WebP.', logoErr_not_an_image: 'Этот файл не является изображением PNG, JPG или WebP.', logo: 'Логотип', logoSub: 'Показывается на странице записи и в CRM', logoHint: 'PNG или JPG, лучше всего квадратное изображение. Без загрузки используется первая буква названия.', logoUpload: 'Загрузить логотип', logoReplace: 'Заменить', logoRemove: 'Удалить', brandSub: 'В этих цветах будет ваша страница записи', brandCustom: 'Свои цвета',
  ...
  en: {
    ...
    set: {
      ...
      brand: 'Branding', logoErr_empty: 'That file is empty.', logoErr_too_large: 'That image is larger than 4 MB. Please upload a smaller file.', logoErr_svg_or_html: 'SVG and HTML files are not accepted. Please upload a PNG, JPG or WebP.', logoErr_executable: 'That is a program, not an image. Please upload a PNG, JPG or WebP.', logoErr_archive: 'That is an archive, not an image. Please upload a PNG, JPG or WebP.', logoErr_pdf: 'That is a PDF, not an image. Please upload a PNG, JPG or WebP.', logoErr_not_an_image: 'That file is not a PNG, JPG or WebP image.', logo: 'Logo', logoSub: 'Shown on your booking page and in the CRM', logoHint: 'PNG or JPG; a square image works best. Without one, the first letter of the business name is used.', logoUpload: 'Upload logo', logoReplace: 'Replace', logoRemove: 'Remove', brandSub: 'Your booking page is shown in these colours', brandCustom: 'Your own colours',
